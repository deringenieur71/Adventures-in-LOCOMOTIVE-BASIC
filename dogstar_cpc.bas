...
140 PRINT "Copyright 1979":print"CPC Version 2020 by SRS"
190 RANDOMIZE time:DEFINT A-Z
200 GOSUB 30300
...
4500 OPENout NO$(0)
4525 FOR I=0 TO LO
4550 PRINT #9,OB(I,0);OB(I,1);OB(I,2)
4575 NEXT I
4625 PRINT #9,TB;TC;CM;DR;BL;MD;GF;DJ;CR;LC
4650 CLOSEout
...
4950 OPENin NO$(0)
4975 FOR I=0 TO LO
5000 INPUT #9,OB(I,0),OB(I,1),OB(I,2)
5025 NEXT I
5075 INPUT #9,TB,TC,CM,DR,BL,MD,GF,DJ,CR,LC
5100 CLOSEIN
5125 GOTO 10300
