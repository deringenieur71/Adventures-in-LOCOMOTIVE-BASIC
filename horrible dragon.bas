10 MODE 2:PRINT"horrible-rotten-dancing-dragon-strikes"
11 PRINT"by Ken Rose 1983 / Converted from ATARI to CPC 122021 by SRS"
12 PRINT"Origin: https://ifdb.org/viewgame?id=2bavj7k3yeckppxj"
13 PRINT:PRINT:PRINT"Please activate CAPS LOCK for better game experience"
15 CALL &BB18
20 CLS
...
170 V1$=A$:GOTO 310
180 V1$=LEFT$(A$,X)
190 IF RIGHT$(A$,LEN(A$)-X)=" "THEN N1$="":GOTO 310
200 N1$=RIGHT$(A$,LEN(A$)-(X+1)):GOTO 310
310 IF V1$="GO"THEN V1$=N1$:GOTO 510
320 IF V1$="NORTH"OR V1$="N"OR V1$="SOUTH"OR V1$="S"OR V1$="EAST"OR V1$="E"OR V1$="WEST"OR V1$="W"THEN 510
330 IF V1$="INVENTORY"OR V1$="INV"OR V1$="I"THEN 710
340 IF V1$="GET"OR V1$="TAKE"THEN 810
350 IF V1$="PUSH"OR V1$="PRESS"THEN 910
360 IF V1$="DROP"THEN 1010
370 IF V1$="QUIT"THEN 3700
380 IF V1$="HIT"OR V1$="STRIKE"OR V1$="BEAT"OR V1$="KILL"THEN 1210
390 IF V1$="EAT"THEN GOSUB 1310:GOTO 110
400 IF V1$="FEED"OR V1$="GIVE"THEN 1410
410 IF V1$="DANCE"THEN 1110
420 IF V1$="LOOK"THEN CLS:RD(R)=0:GOTO 610
490 PRINT:PRINT"I DON'T KNOW HOW TO ";V1$;".":GOTO 110
510 X=R
...
560 IF X=28 AND R=32 THEN 590
570 IF R=28 AND S(28)=32 THEN 3570
580 IF X=28 THEN 3590
590 IF R>0 THEN X=R:CLS:GOTO 610
600 IF R=0 THEN PRINT:PRINT"YOU CAN'T MOVE THAT WAY (I THINK).":R=X:X=0:GOTO 110
610 IF R>19 THEN 618
...
820 GOSUB 2205
830 IF OB(X)=R OR OB(X)=34 THEN 850
840 PRINT:PRINT"YOU CAN'T, AT THE MOMENT.":PRINT:GOTO 890
850 IF X=3 AND OB(7)<34 THEN 3410
860 OB(X)=34
870 IF OB(3)=34 THEN 3400
880 PRINT:PRINT"YOU'VE GOT THE ";N1$;".":PRINT
890 X=0:GOTO 110
910 IF N1$=""THEN PRINT:PRINT"DON'T BE SILLY, I NEED A NOUN!":GOTO 890
920 IF R=11 OR R=18 THEN 940
930 GOTO 990
940 IF R=18 THEN 980
950 IF OB(1)=34 THEN 3060
960 IF N1$="BUTTON"THEN 3050
970 GOTO 3040
980 IF N1$="ROCK"OR N1$="STONE"THEN 3220
990 PRINT:PRINT"I CAN'T ";V1$;" A ";N1$;".":PRINT:GOTO 110
1010 GOSUB 2205
1020 IF OB(X)=34 THEN 1040
1030 PRINT:PRINT"I'M NOT CARRYING THE ";N1$;".":PRINT:GOTO 1080
1040 OB(X)=R
1050 IF N1$="WAGON"AND OB(7)=R THEN 3420
1060 PRINT:PRINT"I'VE DROPPED THE ";N1$;".":PRINT
1070 IF R=28 AND OB(X)=28 THEN OB(X)=0:GOTO 3580
1080 X=0
1090 GOTO 110
...
1120 IF R=28 THEN 3530
1130 PRINT:PRINT"FURRY LITTLE CREATURES APPEAR, APPLAUD FURRIOUSLY, AND LEAVE."
1140 GOTO 110
1210 IF N1$=""THEN PRINT:PRINT"OKAY, BUT YOU HAVE TO TELL ME WHAT IT IS YOU WANT TO ";V1$;".":PRINT:GOTO 110
1220 IF R=9 AND OB(7)<34 THEN 3310
1230 IF R=18 AND OB(2)=34 THEN 3230
1240 IF R=18 THEN 3250
1250 IF N1$="DRUM"OR N1$="DRUMSTICK"THEN 3330
1260 IF R=28 AND OB(2)=34 THEN 3550
1270 IF R=28 THEN 3560
1280 PRINT:PRINT"YOU CAN'T ";V1$;" A ";N1$;" HERE.":GOTO 110
...
1410 GOSUB 2205
1420 IF OB(X)=34 THEN 1440
1430 PRINT:PRINT"YOU CAN'T ";V1$;" SOMETHING YOU":PRINT"DON'T HAVE!":GOTO 110
1440 IF R=28 THEN OB(X)=0:GOTO 3580
1450 PRINT:PRINT"I DON'T KNOW HOW TO TELL YOU THIS, BUT NO ONE WANTS IT.":GOTO 110
...
1620 RD(R)=1:RETURN
1630 DES$="YOU ARE IN THE THRONE ROOM":PRINT DES$:GOSUB 3110
1640 RETURN
...
1710 DES$="NORTH END OF BRIDGE":PRINT DES$:GOSUB 3010
1720 RETURN
...
1850 DES$="VOLCANO VALLEY":PRINT DES$:IF N(18)=14 THEN RETURN
...
2050 DES$="LAIR OF THE DRAGON":PRINT DES$:GOTO 3510
...
2275 IF X=0 THEN PRINT"BE REALISTIC":POP:GOTO 110
2280 RETURN
...
3040 PRINT:PRINT"WHOEVER HEARD OF PRESSING A BUTTON WITH A ";N1$;"?":PRINT:GOTO 110
...
3065 PRINT"OOPS, I'VE DROPPED THE STICK INTO THE RIVER":OB(1)=0:S(11)=15:GOTO 110
...
3085 RD(R)=1:RETURN
3110 IF OB(7)=34 AND OB(3)=34 THEN 3130
...
3220 PRINT:PRINT"YOU PUSH AGAINST IT WITH ALL YOUR MIGHT BUT NOTHING SEEMS TO HAPPEN.":PRINT:GOTO 110
3230 IF N1$="KETTLE"THEN PRINT:PRINT"YOU ";V1$;" THE SWORD AGAINST THE ":PRINT"KETTLE. THE ROCK VIBRATES IN ";
3235 PRINT"TUNE ":PRINT"AND ROLLS ASIDE, REVEALING A PASSAGE TO THE NORTH.":N(18)=14:S(14)=18:GOTO 110
3240 PRINT"YOU ";V1$" THE SWORD AGAINST THE ":PRINT N1$;" BUT NOTHING HAPPENS.":GOTO 110
3250 PRINT:PRINT"YOU ";V1$;" IT WITH YOUR HAND.":PRINT:PRINT"NOTHING SEEMS TO HAPPEN EXCEPT YOUR HAND ";
3255 PRINT"HURTS.":GOTO 110
...
3330 IF OB(4)=34 AND OB(6)=34 THEN 3370
3340 IF OB(4)<>34 AND OB(6)<>34 THEN PRINT"YOU DON'T HAVE THAT.":GOTO 110
3350 IF OB(4)=34 THEN PRINT:PRINT"PERHAPS IF YOU HAD A DRUM...":GOTO 110
3360 IF OB(6)=34 THEN PRINT:PRINT"YOU HIT THE DRUM WITH YOUR HAND AND PRODUCE A MUFFLED THUD.":GOTO 110
3370 IF R=28 THEN 3620
3380 PRINT:PRINT"KABOOM, KABOOM. HITTING THE DRUM WITH THE DRUMSTICK PRODUCES A NICE BEAT. YOU'RE NO GENE ";
3385 PRINT"KRUPA (WHO?), BUT YOU'LL";:PRINT"DO IN A PINCH.":GOTO 110
...
3525 PRINT"SHALL YOU":PRINT"FEED ME FIRST?'":GOTO 110
...
3580 PRINT:PRINT"THE DRAGON GOBBLES UP THE ";N1$;".":PRINT:PRINT"'YUMMY, GOOD! WHAT (OR WHO) IS NEXT?'":GOTO 110
