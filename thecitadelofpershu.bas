...
80 IF A(RO,8)<>0 THEN GOSUB 3180:GOTO 110
90 IF RO=6 AND LI=0 THEN GOSUB 3340
100 IF A(RO,7)<>0 AND LI=1 THEN GOSUB 3340
110 GOSUB 4210
...
570 IF RND(1)>0.5 THEN PRINT "THERE IS AN EXIT TO THE WEST"
580 IF RND(1)>0.5 THEN PRINT "A TUNNEL LEADS TO THE SOUTH"
590 RETURN
600 REM ROOM 2
...
1630 IF RND(1)>0.5 THEN PRINT "A BAT FLIES PAST YOU, SHRIEKING"
...
2550 PRINT "YEARS"
2560 IF RND(1)>0.3 THEN PRINT "BUT NOW IT TELLS YOU THERE IS":PRINT "A HIDDEN STAIRWELL IN THE ROOM"
2570 IF RND(1) >0.7 THEN PRINT "THE VOICE FAINTLY MURMURS OF THE DOOR TO THE SOUTH"
2580 RETURN
2590 REM ROOM 38
...
2680 IF RND(1)>0.4 THEN PRINT "A SMALL DOOR LEADS TO THE NORTH":PRINT "AND ANOTHER TO THE EAST"
...
3260 IF RND(1)>0.5 THEN PRINT "YOU COME FACE TO FACE WITH A ";G$ ELSE PRINT "THE ROOM CONTAINS A ";G$
...
4100 IF RND(1)>0.25 AND HT>0 AND MT>0 THEN FOR T=1 TO 1600:NEXT T:GOTO 3990
...
4310 IF Z$="R" AND RND(1)>0.4 AND A(RO,8)<>0 THEN PRINT "NO, YOU MUST STAND AND FIGHT":Z$="F"
