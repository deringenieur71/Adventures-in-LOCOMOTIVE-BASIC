...
110 LOCATE 1,10:X$="Voyage to Neptune, 2100":GOSUB 1680
120 LOCATE 1,13:X$="(c) by David H. Ahl, 1986":GOSUB 1680
125 LOCATE 1,16:X$=CHR$(24)+"Converted to CPC 2017 by SRS"+CHR$(24):GOSUB 1680
130 LOCATE 1,23:GOSUB 1550
...
290 PRINT" and you covered";DIS(SEG-1);"million miles in";ZEIT;"days."
300 TM=0.81*DIST:PRINT"Time est for this total distance:";:GOSUB 1460
310 TM=TOZEIT:PRINT"Your actual cumulative time was:";:GOSUB 1460
...
790 ZEIT=INT(DIS(SEG)*41667/RATE):'Time in days
800 TOZEIT=TOZEIT+ZEIT:'Total trip time
...
880 PRINT:X$="ENGINE MALFUNCTION !":LOCATE 1,12:GOSUB 1680
...
950 PRINT:PRINT"You finally reached Neptune in";:TM=TOZEIT:GOSUB 1460
...
1000 TM=TOZEIT-2190:PRINT:PRINT"Your trip took longer than this by";
...
1160 GOSUB 1590:IF A$="Y"THEN RUN ELSE CLS:PRINT"Bye!":END
1170 '
...
1690 PRINT TAB((80-LEN(X$))/2);X$;:RETURN